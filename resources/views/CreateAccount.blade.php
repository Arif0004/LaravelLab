...
<div class="box">
    <form action="#">
        ...
        <div class="row">
            ...
            <input class="this controll half" type="email" placeholder="Last email" name="last_name">
...
<p >already have an account?<a style="text-decoration: none;" href="Login.html">sign up</a> </p>
</body>
</html>
